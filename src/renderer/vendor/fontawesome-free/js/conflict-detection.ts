...
(function (global, factory) {
  ...
  var md5 = createCommonjsModule(function (module) {
    ...
    (function ($) {
      ...
      if (module.exports) {
        ...
        // @ts-expect-error TS(2339): Property 'md5' does not exist on type '{}'.
        $.md5 = md5;
      }
    })(commonjsGlobal);
  });
  ...
  function detectSvgConflicts(currentScript) {
    // @ts-expect-error TS(2339): Property 'scripts' does not exist on type '{}'.
  ...
  function conflictDetection() {
    ...
    // @ts-expect-error TS(2339): Property 'onmessage' does not exist on type '{}'.
